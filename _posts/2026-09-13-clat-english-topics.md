...
The trap is that the most vivid part of a passage is often not its main point. An anecdote in the opening paragraph is memorable; it is usually there to introduce the actual argument.

**The right answer** covers the whole passage, not one striking section of it. If an option would be a fair summary of only the second paragraph, it is wrong.
...
Note **as used in the passage**. The dictionary's primary sense is often the distractor. The test is substitution: put each option back in the sentence and read it.

## Structure and purpose

*"The second paragraph serves to —"*

Asks about function, not content. Is the paragraph offering evidence, raising a counter-argument, qualifying what came before?

**The right answer** describes a job, not a topic.

## Author's argument and assumptions

The overlap with [Logical Reasoning](/blog/what-is-logical-reasoning-in-clat/) is real. You may be asked what the author assumes, or which statement would weaken the case made. Same skill, different section heading.

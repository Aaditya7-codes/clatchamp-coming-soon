...
Being straight about this cuts both ways:

- Candidates who **will not** self-direct. If you know from experience that you need external structure, buying it is a rational decision, not a weakness.
- Candidates with **no access to good material or peers**, for whom coaching is the practical route to both.
- Candidates in **Class 12 with a compressed timeline**, where someone else triaging the syllabus saves weeks.
...
Replace the four things deliberately: write a plan, build an error log that gives you your own feedback loop, sit mocks with a large enough cohort to benchmark against, and find at least one other person preparing so the pace is not entirely self-generated.

That is laid out in [is self-study enough for CLAT?](/blog/is-self-study-enough-for-clat/)

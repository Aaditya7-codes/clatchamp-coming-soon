...
What must be true, though unstated, for the argument to work?
...
Which new fact makes the conclusion more likely?

**The test:** find the gap between evidence and conclusion, and ask which option narrows it. Usually by ruling out an alternative explanation.

## Weaken

Which new fact makes the conclusion less likely?

**The test:** the same gap, widened. Most commonly by supplying an alternative cause.

Note that weakening is not contradicting. An option that simply asserts the opposite conclusion is not an argument against it.
...
- **Equivocation** — using one word in two senses

## Method or structure

How does the argument proceed — by analogy, by counter-example, by conceding a point and then qualifying it?

**The test:** describe the paragraph's *job*, ignoring its subject entirely.
